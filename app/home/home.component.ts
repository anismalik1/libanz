...
export class HomeComponent implements OnInit {
  ...
  public webTemplate : boolean = true;
  ...
  region :number = 0;
  activity : number = 0;
  public splash : string = './assets/images/app-icon.png';
  public splash_footer : string = './assets/images/logo.png';
  ...
  web_sliders()
  {
    if($('#web-sliders-script'))
    {
      $('#web-sliders-script').remove();
    }
    var $items = 1;
    let script = this._renderer2.createElement('script');
    script.type = `text/javascript`;
    script.id = `web-sliders-script`; 
    script.text = `
      $(document).ready(function(){
        $('#recommended-items').lightSlider({
          item: 4,
        ...
        $('.flash-deal-slider li').css('display','block');
